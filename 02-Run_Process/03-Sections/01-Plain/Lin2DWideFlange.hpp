...
//
// Description:
///This file contains the "Lin2DWideFlange" section declarations, which 
///defines a circular (I) geometry for 2D analysis with linear elastic 
///material for frame elements.
//------------------------------------------------------------------------------

#ifndef _LIN2DWIDEFLANGE_HPP_
#define _LIN2DWIDEFLANGE_HPP_
...
/// @date      May 14, 2020
/// @version   1.0
/// @file      Lin2DWideFlange.hpp
/// @class     Lin2DWideFlange
/// @see       Section.hpp
/// @brief     Class for creating a wide flange section for 2D analysis with linear elastic material for a frame elements
class Lin2DWideFlange : public Section{
    ...
    public:
        ...
        ///@see Lin2DWideFlange::h, Lin2DWideFlange::b, Lin2DWideFlange::tw, Lin2DWideFlange::tf, Lin2DWideFlange::theMaterial, Lin2DWideFlange::Theta, Lin2DWideFlange::InsertPoint.
