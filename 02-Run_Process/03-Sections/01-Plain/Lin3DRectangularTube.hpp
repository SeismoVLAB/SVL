...
//
// Description:
///This file contains the "Lin3DRectangularTube" section declarations, which 
///defines a hollow rectangular geometry for 3D analysis with linear elastic 
///material for frame elements.
//------------------------------------------------------------------------------

#ifndef _LIN3DRECTANGULARTUBE_HPP_
#define _LIN3DRECTANGULARTUBE_HPP_
...
/// @date      May 10, 2020
/// @version   1.0
/// @file      Lin3DRectangularTube.hpp
/// @class     Lin3DRectangularTube
/// @see       Section.hpp
/// @brief     Class for creating a rectangular tube section for 3D analysis with linear elastic material for a frame elements
class Lin3DRectangularTube : public Section{
    ...
    public:
        ...
        ///@see Lin3DRectangularTube::h, Lin3DRectangularTube::b, Lin3DRectangularTube::tw, Lin3DRectangularTube::tf, Lin3DRectangularTube::theMaterial, Lin3DRectangularTube::Theta, Lin3DRectangularTube::InsertPoint.
