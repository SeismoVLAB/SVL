...
//
// Description:
///This file contains the "Lin2DAngle" section declarations, which defines a 
///Angle geometry in 2D analysis with linear elastic material for a frame 
///elements.
//------------------------------------------------------------------------------

#ifndef _LIN2DANGLE_HPP_
#define _LIN2DANGLE_HPP_
...
/// @class     Lin2DAngle
/// @see       Section.hpp
/// @brief     Class for creating an angle section for 2D analysis with linear elastic material for a frame elements
class Lin2DAngle : public Section{
    ...
    public:
        ...
        ///@see Lin2DAngle::h, Lin2DAngle::b, Lin2DAngle::tw, Lin2DAngle::tf, Lin2DAngle::theMaterial, Lin2DAngle::Theta, Lin2DAngle::InsertPoint.
