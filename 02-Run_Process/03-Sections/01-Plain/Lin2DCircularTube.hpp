...
//
// Description:
///This file contains the "Lin2DCircularTube" section declarations, which 
///defines a hollow circular geometry for 2D analysis with linear elastic 
///material for frame elements.
//------------------------------------------------------------------------------

#ifndef _LIN2DCIRCULARTUBE_HPP_
#define _LIN2DCIRCULARTUBE_HPP_
...
/// @date      May 8, 2020
/// @version   1.0
/// @file      Lin2DCircularTube.hpp
/// @class     Lin2DCircularTube
/// @see       Section.hpp
/// @brief     Class for creating a solid circular tube section for 2D analysis with linear elastic material for a frame elements
class Lin2DCircularTube : public Section{

    public:
        ///Creates a Section to be especified at a Gauss-point in an Element.
        ///@param re The external radius.
        ...
        ///@see Lin2DCircularTube::re, Lin2DCircularTube::ri, Lin2DCircularTube::theMaterial, Lin2DCircularTube::Theta, Lin2DCircularTube::InsertPoint.
    ...
    protected:
        ...
        ///@see The geometric properties can be revisited at @ref linkLin3DCircularTube.
        double GetArea();
