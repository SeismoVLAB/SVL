...
//
// Description:
///This file contains the "Lin3DChannel" section declarations, which 
///defines a circular (C) geometry for 3D analysis with linear elastic 
///material for frame elements.
//------------------------------------------------------------------------------

#ifndef _LIN3DCHANNEL_HPP_
#define _LIN3DCHANNEL_HPP_
...
/// @date      May 6, 2020
/// @version   1.0
/// @file      Lin3DChannel.hpp
/// @class     Lin3DChannel
/// @see       Section.hpp
/// @brief     Class for creating a channel section for 3D analysis with linear elastic material for a frame elements
class Lin3DChannel : public Section{
    ...
    public:
        ...
        ///@see Lin3DChannel::h, Lin3DChannel::b, Lin3DChannel::tw, Lin3DChannel::tf, Lin3DChannel::theMaterial, Lin3DChannel::Theta, Lin3DChannel::InsertPoint.
