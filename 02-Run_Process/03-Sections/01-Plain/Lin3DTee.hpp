...
//
// Description:
///This file contains the "Lin3DTee" section declarations, which defines a 
///Tee (T) geometry for 3D analysis with linear elastic material for frame 
///elements.
//------------------------------------------------------------------------------

#ifndef _LIN3DTEE_HPP_
#define _LIN3DTEE_HPP_
...
/// @class     Lin3DTee
/// @see       Section.hpp
/// @brief     Class for creating a tee section for 3D analysis with linear elastic material for a frame elements
class Lin3DTee : public Section{
    ...
    public:
        ...
        ///@see Lin3DTee::h, Lin3DTee::b, Lin3DTee::tw, Lin3DTee::tf, Lin3DTee::theMaterial, Lin3DTee::Theta, Lin3DTee::InsertPoint.
