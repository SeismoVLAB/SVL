...
//
// Description:
///This file contains the "Lin2DUserDefined" section declarations, which defines 
///a general geometry for 3D analysis with linear elastic material for 
///frame elements.
//------------------------------------------------------------------------------

#ifndef _LIN2DUSERDEFINED_HPP_
#define _LIN2DUSERDEFINED_HPP_
...
class Lin2DUserDefined : public Section{
    ...
    public:
        ...
        ///@see Lin2DUserDefined::theMaterial, Lin2DUserDefined::Theta.
