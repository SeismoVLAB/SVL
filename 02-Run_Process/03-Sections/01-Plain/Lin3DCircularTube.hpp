...
//
// Description:
///This file contains the "Lin3DCircularTube" section declarations, which 
///defines a hollow circular geometry for 3D analysis with linear elastic 
...
/// @date      May 8, 2020
/// @version   1.0
/// @file      Lin3DCircularTube.hpp
/// @class     Lin3DCircularTube
/// @see       Section.hpp
/// @brief     Class for creating a solid circular tube section for 3D analysis with linear elastic material for a frame elements
class Lin3DCircularTube : public Section{

    public:
        ///Creates a Section to be specified at a Gauss-point in an Element.
        ///@param re The external radius of the section.
        ///@param ri The internal radius of the section.
        ...
        ///@see Lin3DCircularTube::re, Lin3DCircularTube::ri, Lin3DCircularTube::theMaterial, Lin3DCircularTube::Theta, Lin3DCircularTube::InsertPoint.
