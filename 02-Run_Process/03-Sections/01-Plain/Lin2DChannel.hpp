...
//
// Description:
///This file contains the "Lin2DChannel" section declarations, which defines 
///a channel geometry in 2D analysis with linear elastic material for frame 
///elements.
//------------------------------------------------------------------------------

#ifndef _LIN2DCHANNEL_HPP_
#define _LIN2DCHANNEL_HPP_
...
/// @date      May 6, 2020
/// @version   1.0
/// @file      Lin2DChannel.hpp
/// @class     Lin2DChannel
/// @see       Section.hpp
/// @brief     Class for creating a channel section for 2D analysis with linear elastic material for a frame elements
class Lin2DChannel : public Section{
    ...
    public:
        ...
        ///@see Lin2DChannel::h, Lin2DChannel::b, Lin2DChannel::tw, Lin2DChannel::tf, Lin2DChannel::theMaterial, Lin2DChannel::Theta, Lin2DChannel::InsertPoint.
        Lin2DChannel(double h, double b, double tw, double tf, std::unique_ptr<Material> &material, double theta=0.0, unsigned int ip=10);

        ///Destroys this Lin2DChannel object.
        ~Lin2DChannel();
    ...
    protected:
        ...
        ///@see The geometric properties can be revisited at @ref linkLin3DChannel
        double GetArea();
