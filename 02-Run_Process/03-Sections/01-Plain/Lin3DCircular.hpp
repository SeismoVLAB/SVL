...
//
// Description:
///This file contains the "Lin3DCircular" section declarations, which 
///defines a circular geometry for 3D analysis with linear elastic 
///material for frame elements.
//------------------------------------------------------------------------------

#ifndef _LIN3DCIRCULAR_HPP_
#define _LIN3DCIRCULAR_HPP_
...
/// @date      May 7, 2020
/// @version   1.0
/// @file      Lin3DCircular.hpp
/// @class     Lin3DCircular
/// @see       Section.hpp
/// @brief     Class for creating a solid circular section for 3D analysis with linear elastic material for a frame elements
class Lin3DCircular : public Section{

    public:
        ///Creates a Section to be specified at a Gauss-point in an Element.
        ///@param r The radius of the section.
        ...
        ///@see Lin3DCircular::r, Lin3DCircular::theMaterial, Lin3DCircular::Theta, Lin3DCircular::InsertPoint.
