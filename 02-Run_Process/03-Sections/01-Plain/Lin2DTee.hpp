...
//
// Description:
///This file contains the "Lin2DTee" section declarations, which 
///defines a circular (T) geometry for 2D analysis with linear elastic 
///material for frame elements.
//------------------------------------------------------------------------------

#ifndef _LIN2DTEE_HPP_
#define _LIN2DTEE_HPP_
...
/// @class     Lin2DTee
/// @see       Section.hpp
/// @brief     Class for creating a tee section for 2D analysis with linear elastic material for a frame elements
class Lin2DTee : public Section{
    ...
    public:
        ...
        ///@see Lin2DTee::h, Lin2DTee::b, Lin2DTee::tw, Lin2DTee::tf, Lin2DTee::theMaterial, Lin2DTee::Theta, Lin2DTee::InsertPoint.
        Lin2DTee(double h, double b, double tw, double tf, std::unique_ptr<Material> &material, double theta=0.0, unsigned int ip=10);

        ///Destroys this Lin2DTee object.
        ~Lin2DTee();
    ...
    protected:
        ...
        ///@see The geometric properties can be revisited at @ref linkLin3DTee.
        double GetArea();
