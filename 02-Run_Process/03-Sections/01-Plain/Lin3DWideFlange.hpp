...
//
// Description:
///This file contains the "Lin3DWideFlange" section declarations, which defines 
///a WideFlange geometry (I) for 3D analysis with linear elastic material for 
///frame elements. 
//------------------------------------------------------------------------------

#ifndef _LIN3DWIDEFLANGE_HPP_
#define _LIN3DWIDEFLANGE_HPP_
...
/// @date      May 14, 2020
/// @version   1.0
/// @file      Lin3DWideFlange.hpp
/// @class     Lin3DWideFlange
/// @see       Section.hpp
/// @brief     Class for creating a wide flange section for 3D analysis with linear elastic material for a frame elements
class Lin3DWideFlange : public Section{
    ...
    public:
        ...
        ///@see Lin3DWideFlange::h, Lin3DWideFlange::b, Lin3DWideFlange::tw, Lin3DWideFlange::tf, Lin3DWideFlange::theMaterial, Lin3DWideFlange::Theta, Lin3DWideFlange::InsertPoint.
    ...
    protected:
        ...
        ///@see The geometric properties can be revisited at @ref linkLin3DWideFlange.
        double GetArea();
