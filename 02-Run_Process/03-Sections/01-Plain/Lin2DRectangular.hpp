...
//
// Description:
///This file contains the "Lin2DRectangular" section declarations, which 
///defines a rectangular geometry for 2D analysis with linear elastic 
///material for frame elements.
//------------------------------------------------------------------------------

#ifndef _LIN2DRECTANGULAR_HPP_
#define _LIN2DRECTANGULAR_HPP_
...
/// @date      May 9, 2020
/// @version   1.0
/// @file      Lin2DRectangular.hpp
/// @class     Lin2DRectangular
/// @see       Section.hpp
/// @brief     Class for creating a solid rectangular section for 2D analysis with linear elastic material for a frame elements
class Lin2DRectangular : public Section{
    ...
    public:
        ...
        ///@see Lin2DRectangular::h, Lin2DRectangular::b, Lin2DRectangular::theMaterial, Lin2DRectangular::Theta, Lin2DRectangular::InsertPoint.
