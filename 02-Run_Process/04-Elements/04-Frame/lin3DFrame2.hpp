...
class lin3DFrame2 : public Element{
    ...
    public:
        ...
        lin3DFrame2(const std::vector<unsigned int> nodes, std::unique_ptr<Section> &section, bool massform=true, bool formulation=false, const std::string quadrature="GAUSS", unsigned int nGauss=3);
