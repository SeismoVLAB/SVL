...
class PML2DQuad8 : public Element{
    ...
    public:
        ...
        PML2DQuad8(const std::vector<unsigned int> nodes, std::unique_ptr<Material> &material, const std::vector<double> parameters, const unsigned int nGauss=4, bool massform=false);
