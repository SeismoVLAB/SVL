...
lin2DQuad8::lin2DQuad8(const std::vector<unsigned int> nodes, std::unique_ptr<Material> &material, const double th, const unsigned int nGauss, bool massform) :
