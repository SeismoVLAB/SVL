...
class PML2DQuad4 : public Element{
    ...
    public:
        ...
        PML2DQuad4(const std::vector<unsigned int> nodes, std::unique_ptr<Material> &material, const std::vector<double> parameters, const std::string quadrature="GAUSS", const unsigned int nGauss=4, bool massform=false);
