...
def parseANSYS(filepath):
    """
    This function parses a *.?? file generated from ANSYS software. Not all functionalities 
    ...
    ----------
    filepath: str
        The path were the ANSYS file will be read
    ...
    """
    #TODO: Implement ANSYS parser 
    print('\x1B[31m ERROR \x1B[0m: The ANSYS parser is not implemented yet')
